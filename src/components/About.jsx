  ...
  return (
    <div className="w-full mt-6 sm:mt-0">
      ...
      <p className="text-md text-justify">
        I believe that in order to build something, it can only be done when a
        solid foundation has been set. That's why I took the time to thoroughly
        study the foundation of web development, HTML and CSS. Once I felt
        comfortable with both, I went on to learn JavaScript and, following
        that, React. I can now say, that I have a solid understanding of the
